...
밥 먹고 나서 html 태그들 MUI로 갈아끼우는 부분 들어가겠습니다.
...
예를 들어
spacing의 경우 Stack 컴포넌트 내에 있는 자식 컴포넌트들끼리의 간격을 나타냅니다. 얘는 full word인데,
mt는 뭔말인지 모르실 확률이 높은데 margin-top의 축약어입니다.
...
git add .
git commit -m "feat: Login Process in Frontend"
git push